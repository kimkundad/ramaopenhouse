                    ...
                    <div id="userbox" class="userbox">
                        <a href="#" data-toggle="dropdown">
                            <figure class="profile-picture">
                              ...
                              @else
                              <img src="{{asset('./assets/images/avatar/1483537975.png')}}" width="35" height="35"  class="img-circle" data-lock-picture="{{asset('./assets/images/avatar/blank_avatar_240x240.gif')}}" />
                              @endif
                            </figure>
